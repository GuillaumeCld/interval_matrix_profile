...
set xtics 2 font 'Latin Modern Roman,24' nomirror 
set ytics 30 font 'Latin Modern Roman,24' nomirror
set y2tics 2 font 'Latin Modern Roman,24' nomirror 
...
# Plot the data
plot file using 1:2 with linespoints linestyle 1 title "Execution Time", \
